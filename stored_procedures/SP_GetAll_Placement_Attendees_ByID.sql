IF NOT EXISTS (
    SELECT 1 
    FROM sys.objects 
    WHERE object_id = OBJECT_ID(N'[dbo].[SP_GetAll_Placement_Attendees_ByID]') 
    AND type = N'P'
)
BEGIN
    EXEC('
        CREATE PROCEDURE [dbo].[SP_GetAll_Placement_Attendees_ByID]  
        ...
        BEGIN    
            SELECT   
                ...
                PA.Attendees_Id,         -- Explicit PA.* columns
                PA.Placement_Id,        
                PA.Student_Id,          
