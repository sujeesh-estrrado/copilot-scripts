IF NOT EXISTS (
    ...
    WHERE object_id = OBJECT_ID(N'[dbo].[SP_Get_ClassTimeTable_ByEmployee_Report_Get_Details]') 
    AND type = N'P'
)
BEGIN
    EXEC('

CREATE PROCEDURE [dbo].[SP_Get_ClassTimeTable_ByEmployee_Report_Get_Details]                       
...
--SELECT DISTINCT
--CT.Class_Timings_Id ,
--CC.Course_Category_Name+'' ''+DE.Department_Name+''-''+C.Course_code     AS Class ,
