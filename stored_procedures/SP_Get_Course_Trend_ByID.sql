IF NOT EXISTS (
    ...
    WHERE object_id = OBJECT_ID(N'[dbo].[SP_Get_Course_Trend_ByID]') 
    AND type = N'P'
)
BEGIN
    EXEC('
CREATE procedure [dbo].[SP_Get_Course_Trend_ByID](@Trend_Id bigint)  
...
WHERE dbo.Tbl_Course_Trend.Del_Trend_Status=0 AND dbo.Tbl_Course_Trend.Trend_Id=@Trend_Id   
