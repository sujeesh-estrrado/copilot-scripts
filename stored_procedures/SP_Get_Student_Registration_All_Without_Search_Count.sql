IF NOT EXISTS (
    ...
    WHERE object_id = OBJECT_ID(N'[dbo].[SP_Get_Student_Registration_All_Without_Search_Count]') 
    AND type = N'P'
)
BEGIN
    EXEC('
    CREATE procedure [dbo].[SP_Get_Student_Registration_All_Without_Search_Count]                                        
AS                                        
BEGIN     
