IF NOT EXISTS (
    ...
    WHERE object_id = OBJECT_ID(N'[dbo].[SP_Get_all_Guadian_details_bymappingid]') 
    AND type = N'P'
)
BEGIN
    EXEC('
CREATE procedure [dbo].[SP_Get_all_Guadian_details_bymappingid] --30108
...
WHERE     Cand_Contact_Mapping_Id=@Cand_Contact_Mapping_Id and Delete_Status=0
