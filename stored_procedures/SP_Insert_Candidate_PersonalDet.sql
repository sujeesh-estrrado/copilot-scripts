IF NOT EXISTS (
    ...
    WHERE object_id = OBJECT_ID(N'[dbo].[SP_Insert_Candidate_PersonalDet]') 
    AND type = N'P'
)
BEGIN
    EXEC('

CREATE procedure [dbo].[SP_Insert_Candidate_PersonalDet]                          
...
@disable_doc,@room_required,@ApplicationStatus,@Option2,@Option3,''Candidatefirst'',@Enquiry_From,@Candidate_Hereaboutus,@Candidate_MaritalStatus,1,@disabilitystatus,@BR1M_Status,@SourceofInformation,@Mode_Of_Study,@Disability_Type,
