IF NOT EXISTS (
    SELECT 1
    FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[Sp_Get_Intake_By_Search]')
    AND type = N'P'
)
BEGIN
    EXEC('
    CREATE PROCEDURE [dbo].[Sp_Get_Intake_By_Search]  -- ''a'' 
    (
    ...
    BEGIN          
        ...
        (
            SELECT             
                ...
                Tbl_Course_Batch_Duration.Batch_Id,   
                ...
                Tbl_Course_Duration.Course_Duration_Month,       
